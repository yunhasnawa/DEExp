...
public:
    ...
    void setupUi(QDialog *ReadDataAutoDialog)
    {
        ...
        buttonBox->setGeometry(QRect(90, 430, 401, 32));
        buttonBox->setOrientation(Qt::Horizontal);
        buttonBox->setStandardButtons(QDialogButtonBox::Cancel|QDialogButtonBox::Ok);
        label_3 = new QLabel(ReadDataAutoDialog);
        label_3->setObjectName(QStringLiteral("label_3"));
        label_3->setGeometry(QRect(8, 10, 71, 16));
        ...
        tedFileNames->setGeometry(QRect(90, 10, 281, 71));
        pbtClear = new QPushButton(ReadDataAutoDialog);
        pbtClear->setObjectName(QStringLiteral("pbtClear"));
        pbtClear->setGeometry(QRect(10, 430, 75, 31));
    ...
    void retranslateUi(QDialog *ReadDataAutoDialog)
    {
        ...
        pbtClear->setText(QApplication::translate("ReadDataAutoDialog", "Clear", 0));
    } // retranslateUi
