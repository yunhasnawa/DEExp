...
public:
    ...
    void setupUi(QDialog *ReadDataDialog)
    {
        ...
        cbxRandom = new QCheckBox(ReadDataDialog);
        cbxRandom->setObjectName(QStringLiteral("cbxRandom"));
        cbxRandom->setGeometry(QRect(10, 50, 141, 17));
    ...
    void retranslateUi(QDialog *ReadDataDialog)
    {
        ...
        label_5->setText(QApplication::translate("ReadDataDialog", "Microseconds", 0));
        cbxRandom->setText(QApplication::translate("ReadDataDialog", "Random Access", 0));
    } // retranslateUi
